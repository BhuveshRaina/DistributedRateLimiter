...
interface RateLimiterConfig {
  ...
  keyConfigs: Record<string, { capacity: number; refillRate: number; algorithm?: string; adaptiveEnabled?: boolean }>;
  patternConfigs: Record<string, { capacity: number; refillRate: number; algorithm?: string; adaptiveEnabled?: boolean }>;
  effectiveKeyConfigs: Record<string, { capacity: number; refillRate: number; algorithm?: string; adaptiveEnabled?: boolean }>;
}
