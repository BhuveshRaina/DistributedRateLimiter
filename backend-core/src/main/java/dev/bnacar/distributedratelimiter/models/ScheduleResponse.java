...
public class ScheduleResponse {
    ...
    private dev.bnacar.distributedratelimiter.ratelimit.RateLimitConfig activeLimits;
    ...
    public static ScheduleResponse from(RateLimitSchedule schedule, boolean active) {
        ...
        response.activeLimits = schedule.getActiveLimits();
    ...
    public dev.bnacar.distributedratelimiter.ratelimit.RateLimitConfig getActiveLimits() {
        return activeLimits;
    }

    public void setActiveLimits(dev.bnacar.distributedratelimiter.ratelimit.RateLimitConfig activeLimits) {
