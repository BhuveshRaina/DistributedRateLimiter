...
public class MetricsService {
    ...
    @Autowired
    public MetricsService(@Autowired(required = false) @Qualifier("rateLimiterRedisTemplate") RedisTemplate<String, Object> redisTemplate,
    ...
    public void clearMetricsByPrefix(String prefix) {
        try {
            ...
            logger.info("Cleared metrics for prefix: {}", prefix);
        } catch (Exception e) {
