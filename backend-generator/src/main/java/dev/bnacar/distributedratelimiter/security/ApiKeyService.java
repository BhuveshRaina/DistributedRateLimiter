...
public class ApiKeyService {
    ...
    @PostConstruct
    public void init() {
        if (apiKeyRepository != null && securityConfiguration.getApiKeys().isEnabled()) {
    ...
    public boolean isValidApiKey(String apiKey) {
        ...
        return apiKeyRepository != null && apiKeyRepository.exists(apiKey);
    }
    ...
    public Set<String> getAllApiKeys() {
        return apiKeyRepository != null ? apiKeyRepository.getAllApiKeys() : Set.of();
    }
    ...
    public void addApiKey(String apiKey, String name, String description) {
        if (apiKeyRepository != null && org.springframework.util.StringUtils.hasText(apiKey)) {
    ...
    public java.util.Map<Object, Object> getMetadata(String apiKey) {
        return apiKeyRepository != null ? apiKeyRepository.getMetadata(apiKey) : java.util.Map.of();
    }
