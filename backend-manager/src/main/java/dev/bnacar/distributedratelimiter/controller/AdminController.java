            ...
            .map((Map.Entry<String, RateLimiterConfiguration.KeyConfig> entry) -> {
                ...
                RateLimiterConfiguration.KeyConfig config = entry.getValue();
                                  ...
                                  return new AdminKeyStats(
                                      ...
                                      config.getCapacity(),
                                      config.getRefillRate(),
                                      config.getCleanupIntervalMs() != null ? config.getCleanupIntervalMs() : configuration.getCleanupIntervalMs(),
                                      config.getAlgorithm() != null ? config.getAlgorithm() : configuration.getAlgorithm(),
                                      currentTime,
                                      true
                                  );            })
